...
//        this code for invisable components
        ...
        datePicker2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dp = new DatePickerDialog(AddTrip.this, datePickerListener2,year, month,
                        day);
...
//                        NetworkInfo mWifi = connManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
    ...
    private TimePickerDialog.OnTimeSetListener timePickerListener = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker timePicker, int i, int i1) {
            ...
            int currentDay = d.get(Calendar.DATE);
    ...
    private TimePickerDialog.OnTimeSetListener timePickerListener2 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker timePicker, int h, int m) {
            ...
            Calendar returnSelectedTime = Calendar.getInstance();
            Calendar c = selected;

            returnSelectedTime.set(Calendar.HOUR_OF_DAY, h);
            returnSelectedTime.set(Calendar.MINUTE, m);

            returnHour = h;
            returnMinute = m;


            if ((year == returnYear) && (month == returnMonth) && (day == returnDay)) {

                if ((c.compareTo(returnSelectedTime) <= 0)) {

                    selectedReturnTime.setText(returnSelectedTime.get(Calendar.HOUR_OF_DAY) + ":" + returnSelectedTime.get(Calendar.MINUTE));


                } else

                {
                    selectedReturnTime.setText("");
                }
            }
            else
            {
                selectedReturnTime.setText(returnHour +":" +returnMinute);
            }
    ...
    private DatePickerDialog.OnDateSetListener datePickerListener2 = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker datePicker, int dateYear, int dateMonth, int dateDay) {
            ...
            selectedReturnDate.setText(new StringBuilder().append(returnYear).append(" - ")
                    .append((returnMonth + 1)).append(" - ").append(returnDay)
                    .append(" "));
